...
def parse_args(Description):
    ...
    parse_compress.add_argument("-T", metavar="threads", type=int, default=util.cpu_physical(), help="默认使用全部物理CPU核心")


    parse_encrypt = parse.add_argument_group("加密", description="目前只使用aes-256-cfb")
    parse_encrypt.add_argument("-e", action="store_true", help="加密")
    parse_encrypt.add_argument("-k", metavar="PASSWORK", action="store", help="指定密码 (default：启动后交互式输入)")
